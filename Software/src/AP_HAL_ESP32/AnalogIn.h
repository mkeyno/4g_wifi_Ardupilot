...
#define ESP32_ANALOG_MAX_CHANNELS 16


#ifdef CONFIG_ARCH_BOARD_ESP32FMU_V1
// these are virtual pins that read from the ORB
#define ESP32_ANALOG_ORB_BATTERY_VOLTAGE_PIN     100
#define ESP32_ANALOG_ORB_BATTERY_CURRENT_PIN     101
#elif defined(CONFIG_ARCH_BOARD_PX4FMU_V2) || defined(CONFIG_ARCH_BOARD_PX4FMU_V4) || defined(CONFIG_ARCH_BOARD_PX4FMU_V4PRO)
#define ESP32_ANALOG_VCC_5V_PIN                4
#define ESP32_ANALOG_ORB_SERVO_VOLTAGE_PIN       102
#define ESP32_ANALOG_ORB_SERVO_VRSSI_PIN         103
#endif

class ESP32::ESP32AnalogSource : public AP_HAL::AnalogSource {
public:
    friend class ESP32::ESP32AnalogIn;
    ESP32AnalogSource(int16_t pin, float initial_value);
    float read_average();
    float read_latest();
...
class ESP32::ESP32AnalogIn : public AP_HAL::AnalogIn {
public:
    ESP32AnalogIn();
    void init() override;
...
private:
    ...
    ESP32::ESP32AnalogSource* _channels[ESP32_ANALOG_MAX_CHANNELS];
