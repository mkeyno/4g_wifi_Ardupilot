...
#include <./src/AC_PID/AC_P.h>               // P library
#include <./src/AC_PID/AC_PID.h>             // PID library
#include <./src/AC_PID/AC_PI_2D.h>           // PI library (2-axis)
#include <./src/AC_PID/AC_PID_2D.h>          // PID library (2-axis)
#include <./src/AP_InertialNav/AP_InertialNav.h>     // Inertial Navigation library
#include "./src/AC_AttitudeControl.h" // Attitude control library
#include <./src/AP_Motors/AP_Motors.h>          // motors library
#include <./src/AP_Vehicle/AP_Vehicle.h>         // common vehicle parameters
