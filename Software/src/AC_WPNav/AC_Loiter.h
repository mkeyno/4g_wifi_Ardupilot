...
#include <./src/AP_InertialNav/AP_InertialNav.h>
#include <./src/AC_AttitudeControl/AC_PosControl.h>
#include <./src/AC_AttitudeControl/AC_AttitudeControl.h>
#include <./src/AC_Avoidance/AC_Avoid.h>
