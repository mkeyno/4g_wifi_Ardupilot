...
#include <./src/AP_Common/Location.h>
#include <./src/AP_InertialNav/AP_InertialNav.h>     // Inertial Navigation library
#include <./src/AC_AttitudeControl/AC_PosControl.h>      // Position control library
#include <./src/AC_AttitudeControl/AC_AttitudeControl.h> // Attitude control library
#include <./src/AP_Terrain/AP_Terrain.h>
#include <./src/AC_Avoidance/AC_Avoid.h>                 // Stop at fence library
