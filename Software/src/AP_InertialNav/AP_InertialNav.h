...
#include <./src/AP_InertialSensor/AP_InertialSensor.h>          // ArduPilot Mega IMU Library
#include <./src/AP_Baro/AP_Baro.h>                    // ArduPilot Mega Barometer Library
#include <./src/AP_Buffer/AP_Buffer.h>                  // FIFO buffer library
#include <./src/AP_NavEKF/AP_Nav_Common.h> // definitions shared by inertial and ekf nav filters
