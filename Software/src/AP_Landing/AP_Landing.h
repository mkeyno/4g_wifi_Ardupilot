...
#include <./src/AP_Mission/AP_Mission.h>
#include <./src/AP_Common/AP_Common.h>
#include <./src/AP_SpdHgtControl/AP_SpdHgtControl.h>
#include <./src/AP_Navigation/AP_Navigation.h>
#include <./src/GCS_MAVLink/GCS.h>
