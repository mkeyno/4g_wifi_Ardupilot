...
#ifdef CONFIG_ARCH_BOARD_ESP32_V1
	#define CONFIG_HAL_BOARD_SUBTYPE    HAL_BOARD_SUBTYPE_ESP32_V1
...
#else
	#error "Unknown ESP32 board type"
#endif
...
#include <./src/AP_HAL_PX4/Semaphores.h>
