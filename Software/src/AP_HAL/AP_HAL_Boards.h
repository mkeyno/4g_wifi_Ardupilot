...
/* HAL ESP32 sub-types, starting at 6000 */

#define HAL_BOARD_SUBTYPE_ESP32_V1	6000
...
/* DEFINITIONS FOR BOARDS */
											...
											#include <./src/AP_HAL/board/sitl.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_PX4
											#include <./src/AP_HAL/board/px4.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_LINUX
											#include <./src/AP_HAL/board/linux.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_EMPTY
											#include <./src/AP_HAL/board/empty.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_VRBRAIN
											#include <./src/AP_HAL/board/vrbrain.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS
											#include <./src/AP_HAL/board/chibios.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_F4LIGHT
											#include <./src/AP_HAL/board/f4light.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_ESP32
											#include <./src/AP_HAL/board/ESP32.h>											
#else
