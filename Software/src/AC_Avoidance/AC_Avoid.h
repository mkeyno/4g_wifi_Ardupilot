...
#include <./src/AP_AHRS/AP_AHRS.h>     // AHRS library
#include <./src/AC_AttitudeControl/AC_AttitudeControl.h> // Attitude controller library for sqrt controller
#include <./src/AC_Fence/AC_Fence.h>         // Failsafe fence library
#include <./src/AP_Proximity/AP_Proximity.h>
#include <./src/AP_Beacon/AP_Beacon.h>
